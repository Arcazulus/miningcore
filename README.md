...
<img src="https://github.com/Arcazulus/miningcore/raw/master/logo.png" width="150">
...
Code contributions are very welcome and should be submitted as standard [pull requests](https://docs.github.com/en/pull-requests) (PR) based on the [`dev` branch](https://github.com/Arcazulus/miningcore/tree/dev).

## Building on Debian/Ubuntu

```console
git clone https://github.com/Arcazulus/miningcore
cd miningcore
```
...
Refer to [this file](https://github.com/Arcazulus/miningcore/blob/master/src/Miningcore/coins.json) for a complete list.
